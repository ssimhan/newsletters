...
_I navigated willingness to pay for Superhuman many years ago._

_We did something remarkable. We established a premium price point for a product that had always been free. But getting there wasn’t easy._

_I studied Van Westendorp. I read conjoint papers. I stumbled through conversations._

_I wished for a simple guide._

_This essay is that. What follows is the clearest explanation of willingness to pay I’ve seen. Every founder should internalize it._

_This is a guest post from [Fynn Glover](https://www.linkedin.com/in/fynn-glover-b0410015/), Founder & CEO of [Schematic](https://schematichq.com/?utm_source=gauravnewsletter&utm_medium=newsletter&utm_campaign=book2026&utm_content=schematic), from his pricing & packaging book: **You’re Leaving Money on the Table**._
...
This gave me the opportunity to meet [James Wood](https://www.linkedin.com/in/jameschristopherwood/), who ran Insight’s Center of Excellence on pricing.
...
As Xano founder & CEO [Prakash Chandran](https://www.linkedin.com/in/prakawesome/) puts it,
...
1.  **Clarity:** Do you understand what value you create and how to express it?
    
2.  **Confidence:** Can you deliver your price narrative with confidence, poise, and persuasion?
    
3.  **Consistency:** Does every team inside your company tell the same story?
...
1.  **Context & Framing:** Explain your product’s promise. Get the buyer in the right mental model.
    
2.  **Perceived Value:** Ask what problems they think it solves, and which features feel indispensable.
    
3.  **Relative Value:** Compare your value to the tools they already pay for. If they spend $100K/yr on Salesforce and think your product is 50% as valuable, they’re indicating that they’d value your product at ~$50K/yr.
    
4.  **Price Metric:** Explore which metric best maps to their perceived value — seats, usage, API calls, customers, etc.
    
5.  **Packaging Schema:** Show draft tiers (Good/Better/Best). Ask what resonates and what feels off.
    
6.  **Maximum WTP:** Either open-ended (“What’s the max you’d pay?”) or scenario-based (“At $X, what happens?”).
    
7.  **Influence Drivers:** Uncover the real factors — budget, comparables, frequency, stakeholder buy-in.
    
8.  **Feedback & Emotion:** End by asking how the conversation _felt_. You’re listening for discomfort, not just answers.
...
I think **[Van Westendorp](https://en.wikipedia.org/wiki/Van_Westendorp%27s_Price_Sensitivity_Meter)** is a good tool when you’re selling a simple product with a single price point, and you want a quick read on perceived expensiveness.

It’s fast and directional.

But it doesn’t capture usage, value metrics, hybrid pricing, or real buyer psychology.

I think **[conjoint analysis](https://en.wikipedia.org/wiki/Conjoint_analysis)** is a good tool when you have a **large statistical sample size**, well-defined packaging options, and the time and budget to run a proper survey.
...
As pricing expert [Kris Szyszkiewicz](https://www.linkedin.com/in/krzysztof-szyszkiewicz/) puts it,
...
[Kent Keirsey](https://www.linkedin.com/in/kentkeirsey/), founder of [Invoke.ai](http://invoke.ai), framed this perfectly when he told me his philosophy:
...
That’s what this chapter is about: building the evidence to _earn_ your price, so you can broadcast that belief & confidence to the market.
...
You’ve used discovery to _find_ the value.

The next step is to _package_ that value.
...
> 
> — [Madhavan Ramanujam](https://www.linkedin.com/in/madhavansf/), _Monetizing Innovation_

* * *

_Thank you for reading._

_As a reminder, to get your copy of **You’re Leaving Money on the Table**, [click here](https://schematichq.com/book?utm_source=gauravnewsletter&utm_medium=newsletter&utm_campaign=book2026&utm_content=schematic) (online) or [click here](https://www.amazon.com/dp/B0G545Y16J) (print)._
