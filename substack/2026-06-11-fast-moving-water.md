...
Meanwhile, these founders can’t help but notice startups in fast-moving water who seem to win _regardless_ of how they execute.
...
But _unlike_ genes, you’re not stuck with your space[1](#footnote-1).
...
A startup I’ve advised for over a year, [GPTZero](http://gptzero.me), builds the world’s leading AI text detector. The explosion of AI provides epic tailwinds. Each month there is dramatically more AI text. More AI text demands more AI detection. With no sign of slowing.

Another, [Wispr Flow](http://wisprflow.com), builds the best voice-to-text imaginable. This one’s interesting as voice to text isn’t new — I remember when a Dragon NaturallySpeaking dictaphone showed up in my house in the 1990s.

But the space is exploding. Not because dramatically more people are communicating online (though that’s directionally true). The strongest tailwind is an uptick in people talking to _AI_. We ramble at Claude. Developers prompt Cursor. Lawyers mutter to Harvey. This trend makes Wispr Flow a must-have and, again, has no sign of slowing.
...
Of course, by the time you have a product, customers, and a reputation, shifting focus can be challenging. I [recently described the challenges of embarking on Act 2](https://substack.gauravvohra.com/p/act-2).
...
Meanwhile, other team members end up with their heads buried in the sand. The reason is obvious: company success (not to mention everyone’s livelihood) depends on _avoiding_ distractions.

The best founders clear both hurdles.

They know that space should be frequently revisited. And they make time to do it.

Examples of startups successfully switching swimlanes are everywhere[2](#footnote-2).

Replit was founded in 2016. They spent [9 years cycling through product angles and business models](https://techcrunch.com/2025/10/02/after-nine-years-of-grinding-replit-finally-found-its-market-can-it-keep-it/). In late 2024 they fully reoriented around the fast-moving water of AI coding agents. This ended an almost decade-long grind, jumping to hundreds of millions in ARR in under a year.

Superpower started in blood tests, but is gearing up to [shift towards peptides](https://peptide-waitlist.superpower.com/peptides). While blood testing is lucrative — Function Health reached $100M in ARR in just a few years — peptides are several orders of magnitude faster moving.
...
What excites them enough to spend spare time on are likely spaces that are about to explode[3](#footnote-3).

* * *

Paul Graham [defined a startup by its growth](https://paulgraham.com/growth.html). But where does that growth come from?
...
Is switching swimlane the same as a Lean Startup pivot? Similar. A pivot is usually in response to something _failing_. Startups can seek fast-moving water even when they’re _winning_, i.e. shifting from a decent market into an excellent one.
