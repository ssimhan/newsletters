...
_Brought to you by [Adora](https://www.adora.so/?utm_source=newsletter&utm_medium=banner&utm_campaign=FebLaunch&utm_id=gauravvohra)._

[

![](https://substackcdn.com/image/fetch/$s_!4dEV!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb2d34b62-7726-48b9-8ee7-7794307155ff_3840x2160.png)



](https://substackcdn.com/image/fetch/$s_!4dEV!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb2d34b62-7726-48b9-8ee7-7794307155ff_3840x2160.png)

_See why [product-obsessed teams like Notion, Canva, Replit, and Granola](https://www.adora.so/case-studies/?utm_source=newsletter&utm_medium=banner&utm_campaign=FebLaunch&utm_id=gauravvohra) use Adora to map their entire product, document every screen in a live design library, and surface then fix user friction. Get started [here](https://www.adora.so/?utm_source=newsletter&utm_medium=banner&utm_campaign=FebLaunch&utm_id=gauravvohra)._
...
It suggests if you improve it, _everything_ downstream will improve.

But real experiences don’t work this way.

It’s impossible to improve the business by _just_ focusing on the “aha moment”.
...
To keep it moving, you must release the _next_ gate… and the next… and so on.
...
They are all lower-intent than users who _already_ found value in your product.
...
![](https://substackcdn.com/image/fetch/$s_!4zUO!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F01d315a0-524b-4138-b26d-737f9f6dc8c6_4000x2666.png)



](https://substackcdn.com/image/fetch/$s_!4zUO!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F01d315a0-524b-4138-b26d-737f9f6dc8c6_4000x2666.png)

[Casey Winters](https://www.linkedin.com/in/caseywinters/) and [Shaun Clowes](https://www.linkedin.com/in/shaun-clowes-80795014/) define these precisely. I consider these mandatory reading if you are driving activation:
...
> _  
> — [Define your aha moment](https://www.reforge.com/guides/define-your-aha-moment)_
...
>   
> _— [Define your habit moment](https://www.reforge.com/guides/define-your-habit-moment)_
...
Then consider how the _full_ user journey must change for more users to succeed.
...
A better mental model, per [Adriel Frederick](https://www.linkedin.com/in/adrielfrederick/) on [Lenny’s podcast](https://youtu.be/P3xSEIrIoC4):
...
But to _actually improve the customer experience_?
...
At [Superhuman](http://superhuman.com) we wanted a product action to define our “aha moment”.
...
This brain should think like a hotel manager responsible for the _entire_ guest flow.
...
Tools like [Adora](https://www.adora.so/?utm_source=gauravvohra&utm_medium=partner&utm_campaign=Feb-2026) make this remarkably easy. Especially when your onboarding grows in complexity across use-cases, languages, devices, and more.
...
1.  Value: Each new user experiences core value
    
2.  Virality: Each new user creates more new users
    
3.  Network: Every connection strengthens the network, raising value for all
...
1.  Identify all your growth levers
    
2.  Figure out how they relate to new users
    
3.  Tastefully add them to the new user journey
    

For example, [Superhuman](http://superhuman.com) asks new users to invite their team before they land in the product.

I remember the pushback:

_“Why are we prioritizing this? How will it improve activation?”_
...
But that one step drives **40% of** _**all**_ **team invites**. It’s probably more valuable than _any_ other activation work the team did.
...
The key, of course, is to insert them _tastefully_.

If you keep it tasteful, you can ask for _a lot_.
